...
import com.example.naving.rx.data.remote.APIS.MARKET_CATEGORIES_URL
...
interface APIService{
    ...
    fun initializeRequest(@Body body: InitializeRemoteRequestBody): Single<BaseResponseModel<RequestRemoteModel>>
