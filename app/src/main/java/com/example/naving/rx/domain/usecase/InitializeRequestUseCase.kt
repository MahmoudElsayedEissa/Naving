...
class InitializeRequestUseCase @Inject constructor(
    private val repository: RequestsRepository
) {
    operator fun invoke(body: InitializeRequestDomainBody): Single<SingleRequestDomainModel> =
        repository.initializeRequest(body)
}
